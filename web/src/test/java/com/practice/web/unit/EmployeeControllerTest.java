...
class EmployeeControllerTest {
  ...
  void testUpdateEmployeeEmailById() throws Exception {
    ...
    //WHEN
    ResponseEntity<String> responseEntity = employeeController.updateEmployeeEmail(employee.getId(),
        "newemail@gmail.com");
  ...
  void testGetEmployeeByUsernameOrEmail() throws Exception {
    ...
    //WHEN
    ResponseEntity<List> responseEntity = employeeController.getEmployeeByUsernameOrEmail(employee.getUsername(),
        employee.getEmail());
